    ...
    public class VendorController : Controller
    {
        ...
        public ActionResult Create(CreateVendorViewModel model)
        {
            ...
            try
            {
                ...
                vObj.ApplicationUserId = User.Identity.Name;
                ...
                db.Vendors.Add(vObj);
                db.SaveChanges();
                Response.Cookies.Append("FlashMessage", "Success! New Vendor Added.<br />A/C No: " + vObj.Id);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Edit(EditVendorViewModel vVendor)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                Response.Cookies.Append("FlashMessage", "Edit Complete!!");
                return RedirectToAction("Index", "Vendor");
            }
        ...
        public JsonResult GetVendorInformation(int VendorId)
        {
            try
            {
                ...
                else
                {
                    return Json(new
                    {
                    Name = Obj.Name, Address = Obj.Address, Mobile = Obj.Telephone, Email = Obj.Email, }
